...
class MessageSub extends BaseCommand_1.default {
    constructor() {
        super('message', {
            aliases: ['msg', 'm'],
            sunCommands: true,
        ...
        switch (cmd) {
            case 'dm': {
                ...
                await client.databaseManiger
                    ...
                    .then(() => message.channel.send(`DmMessage configs updated to: ${msg}. To preview up ${data.prefix}message test`))
            ...
            case 'main': {
                ...
                await client.databaseManiger
                    ...
                    .then(() => message.channel.send(`Message configs updated to: ${msg}. To preview up ${data.prefix}message test`))
                    .catch(e => message.channel.send(`There was an error trying to update dm configs: ${e.message || e}`));
                break;
            }
            case 'syntax': {
                message.channel.send(new discord_js_1.MessageEmbed().setColor('RANDOOM').addFields([
                    {
                        name: '{{user}}',
            ...
            case 'test': {
                message.channel.send(`Guild: ${client.verifyMessage(((_a = data.guildData) === null || _a === void 0 ? void 0 : _a.Message) || 'nothing found', message.member)}\n DM: ${client.verifyMessage(((_b = data.guildData) === null || _b === void 0 ? void 0 : _b.DmMessage) || 'nothing found', message.member)}`);
                break;
            }
            default:
